...
public class reject_reports extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_reject_reports, container, false);
    ...
    {
        admin_report=v.findViewById(R.id.admin_reject_report);
        ...
        database.child("reject_reports").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snap: snapshot.getChildren()) {
                    database.child("reject_reports").child(snap.getKey().toString()).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
                                ...
                                adapter_report_recycler adapter=new adapter_report_recycler(arrayList,reject_reports.this);
