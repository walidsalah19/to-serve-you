...
public class manager_get_reject_report extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_manager_get_reject_report, container, false);
    ...
    {
        admin_report=v.findViewById(R.id.manager_reject_report);
    ...
    public void getreport()
    {
        ...
        database.child("reject_reports").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot snap : snapshot.getChildren()) {
                        if (snap.getKey().equals(user_id)) {
                            database.child("reject_reports").child(user_id).addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD_MR1) {
                                        ...
                                        manager_adapter adapter = new manager_adapter(arrayList, manager_get_reject_report.this);
